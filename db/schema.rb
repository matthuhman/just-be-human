...
ActiveRecord::Schema.define(version: 2021_05_02_220413) do
  ...
  create_table "cleanup_zones", force: :cascade do |t|
    t.bigint "user_id"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_cleanup_zones_on_user_id"
  end
  ...
  create_table "coordinates", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "cleanup_zone_id"
    t.index ["cleanup_zone_id"], name: "index_coordinates_on_cleanup_zone_id"
  end
